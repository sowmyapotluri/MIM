...
namespace Microsoft.Teams.Apps.Bart.Authentication
{
    using System;
    ...
    public static class AuthenticationServiceCollectionExtensions
    {
        ...
        public static void AddBartAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
